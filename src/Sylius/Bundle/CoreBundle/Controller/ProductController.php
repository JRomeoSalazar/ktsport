...
class ProductController extends ResourceController
{
     ...
     */
    public function indexByTaxonAction(Request $request, $permalink, $view)
    {
        ...
        return $this->renderResponse('SyliusWebBundle:Frontend/Shop/Product:indexByTaxon.html.twig', array(
            'taxon'    => $taxon,
            'products' => $paginator,
            'view'     => $view,
            'permalink' => $permalink
