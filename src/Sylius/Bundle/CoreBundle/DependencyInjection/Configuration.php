...
class Configuration implements ConfigurationInterface
{
    ...
    protected function addEmailsSection(ArrayNodeDefinition $node)
    {
        ...
        $this->addEmailConfiguration($emailNode, 'order_confirmation', 'SyliusWebBundle:Frontend/Shop/Email:orderConfirmation.html.twig');
        $this->addEmailConfiguration($emailNode, 'customer_welcome', 'SyliusWebBundle:Frontend/Shop/Email:customerWelcome.html.twig');
